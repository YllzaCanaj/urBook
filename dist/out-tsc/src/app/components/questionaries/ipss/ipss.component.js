...
let IPSSComponent = class IPSSComponent {
    constructor(dataService, translate, platform, file, sqlite, router, fileOpener, storage, alertController) {
    ...
    ngOnInit() {
        this.dataService.loadIPSSquestions().then((data) => {
            this.questions = data;
    ...
    downloadPDF() {
        ...
        const fileName = 'IPSS_' + new Date().getTime() + '.pdf';
...
], IPSSComponent.prototype, "slides", void 0);
IPSSComponent = tslib_1.__decorate([
    Component({
        selector: 'app-ipss',
        templateUrl: './ipss.component.html',
        styleUrls: ['./ipss.component.scss'],
    }),
...
export { IPSSComponent };
//# sourceMappingURL=ipss.component.js.map